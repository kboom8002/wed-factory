                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {[
                      ...
                      <label key={opt.val} className="cursor-pointer group relative">
                        <input type="radio" name="schedule_window" required value={opt.val} className="peer sr-only" />
                        <div className="p-4 rounded-2xl border-2 border-[var(--brand-text-muted)]/10 bg-[var(--brand-surface)] peer-checked:border-[var(--brand-primary)] peer-checked:bg-[var(--brand-primary)]/5 transition-all text-left group-hover:bg-[var(--brand-text-muted)]/5 relative overflow-hidden">
                          ...
                          <div className="absolute right-4 top-1/2 -translate-y-1/2 w-5 h-5 rounded-full border-2 border-[var(--brand-text-muted)]/20 peer-checked:border-[var(--brand-primary)] peer-checked:bg-[var(--brand-primary)] flex items-center justify-center transition-all">
               ...
               <div>
                  ...
                  <div className="grid grid-cols-1 gap-3">
                    {[
                      ...
                      <label key={opt.val} className="cursor-pointer group relative">
                        <input type="radio" name="budget_band" required value={opt.val} className="peer sr-only" />
                        <div className="p-5 rounded-2xl border-2 border-[var(--brand-text-muted)]/10 bg-[var(--brand-surface)] peer-checked:border-[var(--brand-primary)] peer-checked:bg-[var(--brand-primary)]/5 transition-all text-left flex items-center justify-between">
                          <div>
                          ...
                          <div className="w-6 h-6 rounded-full border-2 border-[var(--brand-text-muted)]/20 peer-checked:border-[var(--brand-primary)] peer-checked:bg-[var(--brand-primary)] flex items-center justify-center transition-all bg-white shrink-0">
